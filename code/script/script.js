...
import ball from "../image/soheeball.jpg";
...
// window.onclick = () => ballCollection.push(generateBall(intersectionPoint));
window.addEventListener("click", () => {
    ballCollection.push(generateBall(intersectionPoint));
});
//--------------------------------------------
